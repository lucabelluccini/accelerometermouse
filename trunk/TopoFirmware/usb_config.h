...
#define HID_EP 					1
#define HID_INT_OUT_EP_SIZE     40
#define HID_NUM_OF_DSC          1
#define HID_INT_IN_EP_SIZE      40
#define HID_RPT01_SIZE          241

#define USER_GET_REPORT_HANDLER MouseGetReportHandler
#define USER_SET_REPORT_HANDLER MouseSetReportHandler
